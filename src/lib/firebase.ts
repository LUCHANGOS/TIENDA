...
// Usa variables de entorno o valores reales como fallback
const firebaseConfig = {
  apiKey: process.env.VITE_FIREBASE_API_KEY || "AIzaSyDH4kqwXjMOWWlkR-vijuYSsO0LRoSu2U",
  ...
  appId: process.env.VITE_FIREBASE_APP_ID || "1:718701294807:web:0ff0deb243471180e6ec92"
};
